            ...
            <div className="relative min-h-screen md:flex">
                ...
                <section
                    className={`bg-slate-100 py-12 ${
                        sideMenuIsExpand ? "md:ml-72" : "md:ml-0"
                    }`}
                >
                    ...
                    <section className=" container mx-auto mt-16">
                        <div className="text-left mb-8">
                            ...
                            <p className="text-gray-600 mt-4">
                                Our Simulation Tests employ an exclusive
                                algorithm to offer you the most accurate
                                simulation of the Canadian Citizenship test.
                                Once you've finished the chapter lessons and
                                quizzes, sharpen your readiness by acing the
                                simulation exams below to ensure you're fully
                                primed for the real exam.
                            </p>
                        </div>
                            ...
                            {Array.from({ length: 3 }).map((_, index) => (
                                ...
                                >
                                    ...
                                    <div className="px-5 py-8">
                                        ...
                                        <p className="text-gray-500 text-base mt-2">
                                            Our exam simulator draws questions
                                            from every chapter with our
                                            proprietary algorithm to provide you
                                            with the most accurate simulation of
                                            the test.
                                        </p>
                                    </div>
                                </div>
                            ...
                            {Array.from({ length: 11 }).map((_, index) => (
                                ...
                                >
                                    ...
                                    <div className="px-5 py-8">
                                        ...
                                        <p className="text-gray-500 text-base mt-2">
                                            Just starting to prepare for the
                                            exam and not sure where to begin?
                                            Quickly identify gaps in your
                                            knowledge of Canada. This test
                                            contains the questions that are most
                                            often missed by our users.
                                        </p>
                    ...
                    <section className="container mx-auto mt-16">
                        <div className="text-left mb-8">
                            ...
                            <p className="text-gray-600 mt-4">
                                ...
                                extensive timeline of Canada’s history,
                                Important People, Interactive Maps and much
                                more. Our preparation tools have helped
                                thousands pass their Canadian Citizenship Test.
                            </p>
                        </div>
                                ...
                                >
                                    ...
                                    <div className="px-5 py-8">
                                        ...
                                        <p className="text-gray-500 text-base mt-2">
                                            ...
                                            actual test based on your current
                                            study plan and completed goals.
                                        </p>
                                    </div>
                                </div>
                            ))}
