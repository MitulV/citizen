                    ...
                    <div className="container mx-auto flex flex-col md:flex-row rounded-2xl overflow-hidden bg-white shadow-sm p-8">
                        ...
                        <div className="w-full md:w-1/2 p-8">
                            ...
                            <p className="text-base sm:text-sm mb-4 text-gray-600">
                                Our exam simulator draws questions from every
                                chapter of Discover Canada with our proprietary
                                algorithm to provide you with the most accurate
                                simulation of the Citizenship Test. This test
                                also includes our AI-powered Weakness Analysis
                                which allows you to quickly identify gaps in
                                your knowledge of the chapter by viewing a
                                detailed evaluation of detected weaknesses at
