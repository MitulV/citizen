    ...
    return (
        <>
            <AuthenticatedLayout user={auth.user} isChapterPanelVisible={true}>
                ...
                {/* Main content */}
                <section className="container max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl px-4 sm:px-6 md:px-8 lg:mx-96 py-6 sm:py-8 md:py-10 lg:py-12 mx-auto bg-slate-50 rounded-3xl">
